    ...
    const redirUrl = await fetch(
        ...
        .then(async (resp) => {
            if (resp.ok) {
                ...
                console.log(
                    `Couldn't get auth URL: ${resp.status} ${resp.statusText}`
                );
                return null;
            }
        })
            ...
            <div className="content-wrapper">
                <div className="sign-up-wrapper">
                    ...
                    <div className="sign-up-explanation">
                        ...
                        automatically saved in the alt-text.org database? Click "Sign Up" and
                        give us permission, and we'll start right away! You don't need to do anything else!
                        <div><b>
                            *Note: This currently will not work on some mobile devices, Twitter is working on it*
                        </b></div>
                    </div>
                    <div className="sign-up-controls">
                        ...
                        <br/>
                        <button className="std-button" onClick={() => document.location.href = '/'}>
                            Return To Search
                        </button>
                    </div>
                </div>
